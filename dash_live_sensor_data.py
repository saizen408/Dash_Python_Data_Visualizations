...
app = dash.Dash('vehicle-data', external_scripts=external_js,
...
def update_obd_value(times, oil_temps, intake_temps, coolant_temps, rpms, speeds, throttle_pos):
...
times, oil_temps, intake_temps, coolant_temps, rpms, speeds, throttle_pos = update_obd_value(
...
def update_graph(data_names, n):
    ...
    graphs = []
    update_obd_value(times, oil_temps, intake_temps,
